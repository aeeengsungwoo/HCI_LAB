...
def split_and_equalize_rgb_channels(image_path, r_output_path, g_output_path, b_output_path, r_eq_output_path,
                                    g_eq_output_path, b_eq_output_path):
...
try:
    split_and_equalize_rgb_channels(
        'jenny.jpg',
